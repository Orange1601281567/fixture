...
//         .antMatchers( "/static/assets/**" ).permitAll()//允许访问匹配的路径
//         .antMatchers( "**/assets/**" ).permitAll()//允许访问匹配的路径
         .antMatchers( "/assets/css/**" ).permitAll()//允许访问匹配的路径
         .antMatchers( "/assets/js/**" ).permitAll()//允许访问匹配的路径
         .antMatchers( "/assets/img/**" ).permitAll()//允许访问匹配的路径
//         .antMatchers( "/static/assets/css/**" ).permitAll()//允许访问匹配的路径
//         .antMatchers( "/static/assets/js/**" ).permitAll()//允许访问匹配的路径
//         .antMatchers( "/static/assets/img/**" ).permitAll()//允许访问匹配的路径
//         .antMatchers( "/static/**" ).permitAll()//允许访问匹配的路径
//         .antMatchers( "/resources/**" ).permitAll()//允许访问匹配的路径
         .antMatchers( "/index.html" ).permitAll()//允许访问匹配的路径
